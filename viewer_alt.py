...
import trimesh # For OBJ/STL/PLY loading
    ...
    def load_model(self, filename):
        ...
        try:
            if ext in [".obj", ".stl", ".ply"]:
                ...
                # Try to load texture if available (OBJ only)
                if ext == ".obj" and hasattr(mesh.visual, "material") and hasattr(mesh.visual.material, "image"):
                    ...
                    try:
                        if isinstance(texture_data, str) and os.path.exists(texture_data):
                            ...
                            with tempfile.NamedTemporaryFile(suffix=".png", delete=False) as temp_file:
                                texture_data.save(temp_file.name)
